...
export default function SessionsViewPage({ searchParams }: { searchParams?: { player_id?: string; session_id?: string } }) {
  ...
  return (
    <div style={{ display: 'flex', justifyContent: 'center', paddingTop: 20 }}>
      <div style={{ position: 'relative', width: 393, height: 852, background: '#ffffff', padding: 12, boxSizing: 'border-box' }}>
        ...
        <a href="/admin" style={{ position: 'absolute', left: 16, top: 794, padding: '8px 12px', background: '#000', color: '#fff', borderRadius: 8, border: 'none', display: 'inline-block', textDecoration: 'none' }}>Back</a>
      </div>
    </div>
  );
}
