    ...
    overall: [
      {
        ...
        refuses: ["None"],
        anchors: [
          "Player misses first serve into the net then misses second serve long",
          "First serve goes in softly down the middle. Opponent returns aggressively",
          "First serve goes in and opponent misses return",
      ...
      },
      {
        ...
        description: "Serve is reliable inside a comfort zone, with moderate pace and basic spin control. Breakdowns occur when asked to increase pace, vary direction, or respond to return pressure. Execution depends on stable external conditions.",
        process: [
          "Can hit short sequences of solid serves",
        ...
        outcomes: [
          "Solid first serve that doesn't create opportunity",
        ...
        anchors: [
          "Player serves 2–3 safe first serves in a row",
      ...
      },
      {
        ...
        breakdown: [
          "Attempted aces or pace/spin combination beyond reliable execution",
          "Slight misjudgment of toss or timing",
          "Opponent consistently absorbs well-paced/spin serves",
        ...
        refuses: [
          "Pace or spin does not usually produce mechanical loss",
          "Does not lose directional placement under normal match conditions",
          "Opponent adjustments rarely force an immediate structural breakdown",
          "Minor fatigue or distraction does not typically collapse the routine",
        ],
        anchors: [
          "Player averages two solid first serves per game that hit preferred targets",
          "Serves that hit targets set up an opportunity to build offensively",
      ...
      },
      {
        ...
        description: "Serve is tactically integrated and stable under match pressure. Pace, spin, and directional variation are reliable, with low error rates. Mistakes appear only under elevated return intensity or fatigue.",
        process: [
          "Serve routine is consistent under match pressure",
        ...
        refuses: [
          "Consistent failure when attempting high-pace or ace-focused serves",
          "Persistent toss or timing misjudgments",
          "Sustained collapses from opponent anticipation or adjustments to serve",
          "Losing core mechanics due to typical match fatigue",
        ],
        anchors: [
          "Player hits three solid first serves in a row with pace and placement",
          "After opponent wins point set up by strong return, player responds with a well-placed serve to win following point",
          "Player executes second serve safely with spin to force neutral rally",
        ],
      },
      {
        min: 25,
        ...
        refuses: [
          "Does not suffer minor timing or depth fluctuations that compromise serve intent",
          "Does not structurally break under strong or sustained opponent pressure",
          "Does not lose intended serve direction when opponents adjust or increase pace",
          "Does not see core mechanics degrade due to typical match fatigue",
          "Does not consistently fail when attempting high-pace or ace-focused serves",
        ],
        anchors: [
          "Player hits wide slice in deuce court and forces returner 3–4 feet off the court then finishes within two balls",
      ...
      },
      {
        ...
        breakdown: [
          "Breaks only under exceptional, multi-factor conditions.",
          "Sustained extreme physical overload across matches or multi-day tournaments causing extended leg-drive or toss inconsistency",
          "Acute injury or sudden loss of power (muscle strain, cramp) that immediately disrupts timing or contact",
          "Very rare timing or contact-point slips under extreme, acute stress combined with fatigue",
          "Near-ace targeting may fault only when combined with marginal external conditions or extreme risk-taking",
          "Severe environmental or medical extremes (strong wind + wet court, heat exhaustion, significant illness) that disrupt automated mechanics",
        ],
        outcomes: [
          ...
          "Occasional faults that are a small margin from what would be an ace when targeting tight corners",
        ],
        refuses: [
          "Does not typically collapse under sustained scoreboard or return pressure",
          "Does not lose serve depth or leg-drive consistency in long deuce games",
          "Does not have core mechanics broken by aggressive second-serve attacks",
          "Does not exhibit mechanical sequencing errors under match stress",
          "No persistent loss of recovery, timing, or mechanical consistency after deliberate max‑power serving sequences",
        ],
        anchors: [
          "Player hits 6 high-speed first serves. Opponent reads spin but misjudges placement",
          "Serve lands within inches of sideline. Opponent stretches, floating defensive return. Player steps in for put-away winner",
        ],
      },
      {
        min: 41,
        ...
        process: [
          ...
          "Depth lands within 1–2 feet of the service box line",
        ...
        breakdown: [
          "Opponent pairs perfect anticipation with elite, repeatable return execution for extended sequences, forcing tactical mismatches",
          "Extreme physical fatigue (late 3rd set or very high serving volume) causing temporary leg-drive or toss inconsistency",
          "Rare timing or contact-point slips under acute stress",
          "Misses when aiming for extremely tight zones; attempts near-ace can result in small-margin faults",
          "Short windows of degraded recovery or timing after repeated max-power serving sequences",
          "Environmental or health extremes (wind, heat, minor illness) that briefly disrupt mechanics",
        ],
        outcomes: [
        ...
        refuses: [
          "Rarely (if ever) experiences temporary leg-drive or toss inconsistency, even after very high serving volumes",
          "Opponents cannot reliably anticipate spin or location to force tactical mismatches",
          "Rare timing or contact-point slips under acute match stress",
          "Does not systematically miss tight targets, though high-risk near-ace attempts sometimes produce small-margin faults",
          "Maintains recovery and timing after repeated max-power serving sequences",
          "Mechanics remain stable across typical environmental or minor health extremes",
          "Does not exhibit persistent loss of depth, disguise, or sequencing under neutral or elevated match pressure",
        ],
        anchors: [
          "Player hits 6 first serves at maximum pace. Opponent reads spin but misjudges placement.",
          "Player disguises direction until last millisecond. Ball lands within inches of sideline.", 
          "Opponent stretches, floating defensive reply. Player steps in for put-away winner",
        ],
      },
    ],
  power: [
    ...
    overall: [
      {
        ...
        process: [
          ...
          "Split step is absent",
          "Preparation begins after the ball has already crossed the net or not at all",
        ...
        breakdown: [
          ...
          "Body serves",
          "Serves that bounce above shoulder height",
          "Score awareness",
        ],
        outcomes: [
        ...
        anchors: [
          "Opponent serves. Player misses return into the net OR Blocks return softly down the middle; Opponent attacks the next ball", 
          "Return clips the frame and lands in; Opponent misses next shot.", 
          "Point won through opponent error or accidental contact, not through intentional depth, direction, or pressure",
        ],
      },
      {
        min: 7,
        ...
        process: [
          "Return quality depends on serve speed and trajectory being within the player's ideal contact zone",
          "Split step is fairly consistent and timed reasonably with the server’s contact",
        ...
        breakdown: [
          "Wide, body serves that push the returner off-balance",
          "Moderate increases in first-serve pace that force late or defensive contact",
          "Sudden direction changes that disrupt timing",
          "Slight fatigue after a longer rally exchange",
          "Attempts to attack or place returns aggressively causing errors",
        ],
        outcomes: [
        ...
        anchors: [
          "Opponent serves moderately wide. Player steps in and returns safely down the middle.", 
          "Serve comes fast. Player attempts a crosscourt attack. Contact is slightly late or short. Opponent attacks the ball.", 
          "Points won off the return are usually because the opponent misjudges or because the return is within comfort zone and executed solidly.",
        ],
      },
      {
        min: 13,
        ...
        process: [
          ...
          "Preparation allows early racquet positioning",
          "Split step is consistent and timed with server’s contact",
          "Contact point is regularly in front of the body",
          "Quality is repeatable and allows controlled follow-up",
        ],
        breakdown: [
          "Repeated serve pressure produces shorter, attackable returns",
          "High-risk serve attempts increase return errors and mishits",
          "Sustained serve pace compresses reaction time and preparation",
          "Serve placement patterns force late movement and off-balance contact",
          "Wide or body serves create rushed or defensive returns",
          "Fatigue slows first-step reactions and return positioning"
        ],
        outcomes: [
        ...
        refuses: [
          "Does not frequently commit return unforced errors in neutral conditions",
          "Does not allow serves from similar-level opponents to immediately decide the point; regularly produces a controlled next shot",
          "Does not regularly exhibit gross mechanical breakdowns under typical match play",
          "Does not produce chronic mis-hits; contact quality is generally stable",
          "Does not rely solely on opponent errors to win points from the return",
        ],
        anchors: [
          "Player steps in and returns 2nd serve crosscourt safely", 
          "Next serve comes slightly faster and wider. Player adjusts and hits a firm return. Opponent defends short.", 
          "Point won through controlled return + deliberate construction of rally.",
        ],
      },
      {
        min: 19,
        ...
        process: [
          ...
          "Anticipation of favored opponent serve patterns",
          "Can neutralize first serves with controlled depth",
          "Second serve returns are assertive but measured",
        ],
        breakdown: [
          "Return depth insufficient, allowing consistent Serve+1 attacking opportunities",
          "Serve pace pushes contact back, reducing return depth and control",
          "Serve patterns create predictable returns enabling early server attacks",
          "Return shot quality declines under sustained high-pace serving pressure",
          "Wide or body serves create attack lanes on Serve+1",
          "Cumulative pressure produces shorter returns and increased server advantage"
        ],
        outcomes: [
        ...
        refuses: [
          "Does not get routinely pushed off-balance by moderate increases in first-serve pace or sequences of wide/body serves",
          "Does not allow disguised spin or sudden direction changes to consistently beat timing",
          "Does not produce regular short or weak returns under typical match pressure",
          "Does not fail to adjust footwork and decisions depending on opponent serve",
          "Does not show meaningful first-step or recovery loss across standard match durations",
        ],
        anchors: [
          "Opponent hits solid first serve wide. Player gets clean contact crosscourt, neutralizes depth, stays in rally, works point crosscourt, steps in and redirects.",
          "point won through neutralization + controlled construction.",
        ],
      },
      {
        min: 25,
        ...
        breakdown: [
          "Return lands neutral, allowing server to regain attack positioning",
          "Elite serve pace reduces return depth and neutralization",
          "Wide serves stretch positioning, opening Serve+1 attack space",
          "Serve patterns anticipate returns and create early attack lanes",
          "Heavy spin serves disrupt timing and reduce return penetration",
          "Sustained serve pressure gradually lowers return shot quality"
        ],
        outcomes: [
        ...
        refuses:   [
          "Does not allow server to regain attack positioning from neutral returns",
          "Maintains consistent depth and penetration against elite first-serve pace",
          "Retains positioning against wide or angled serves without opening attack lanes",
          "Handles high-spin serves without timing disruption",
          "Maintains shot quality across sustained pressure sequences"
        ],
        anchors: [
      ...
      },
      {
        ...
        breakdown: [
          "Elite serve pace slightly reduces return depth and penetration",
          "Wide serves displace positioning, reopening court for Serve+1 attack",
          "Serve patterns anticipate return direction, preserving attacking initiative",
          "High-kick serves elevate contact, limiting aggressive return placement",
          "Returns land neutral, allowing server to reestablish attack positioning",
          "Sustained serve pressure gradually creates Serve+2 attacking opportunities"
        ],
        outcomes: [
        ...
        refuses:  [
          "Does not lose return consistency under extreme serve pace or spin",
          "Maintains depth and placement even when displaced by wide or body serves",
          "Neutralizes most first-serve attacking opportunities, forcing server into longer sequences",
          "Handles high-kick or deceptive serves without losing positioning or aggression",
          "Avoids technical breakdowns in extended pressure rallies"
        ],
        anchors: [
      ...
      },
      {
        ...
        breakdown: [
          "Elite pace serves reduce return depth minimally",
          "Extreme wide serves displace positioning, opening subtle attack lanes",
          "Serve patterns anticipate returns, preserving server initiative",
          "High-spin or kick serves limit aggressive return placement",
          "Returns land neutral, allowing server subtle early point control",
          "Sustained elite serve sequences create minor Serve+2 opportunities"
        ],
        outcomes: [
        ...
        refuses: [
          "Does not allow elite servers to regain subtle point advantage after neutral return",
          "Maintains depth and precision despite extreme serve speed, spin, and placement",
          "Retains elite positioning under continuous tactical pressure",
          "Handles Serve+2 or multi-shot attacking opportunities without losing control",
          "Avoids any temporary lapses in precision or court coverage"
        ],
        anchors: [
