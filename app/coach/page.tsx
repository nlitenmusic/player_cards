...
export function CoachBottomNav() {
  ...
  return (
    <div id="bottomNav" className="bottom-nav" style={{ position: 'fixed', left: 0, right: 0, bottom: 0, height: 64, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '8px 12px', background: '#fff', boxShadow: '0 -4px 20px rgba(0,0,0,0.08)', zIndex: 9999, gap: 24 }}>
      <button aria-label="Cards" title="Cards" type="button" onClick={() => { try { router.push('/'); } catch (e) { try { window.location.href = '/'; } catch (err) {} } }} style={{ background: 'transparent', border: 'none', cursor: 'pointer', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 4 }}>
      ...
      <button onClick={() => { try { router.push('/leaderboards'); } catch (e) { try { window.location.href = '/leaderboards'; } catch (err) {} } }} aria-label="Leaderboards" title="Leaderboards" type="button" style={{ background: 'transparent', border: 'none', cursor: 'pointer', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 4 }}>
      ...
      <button onClick={() => { try { router.push('/achievements'); } catch (e) { try { window.location.href = '/achievements'; } catch (err) {} } }} aria-label="Achievements" title="Achievements" type="button" style={{ background: 'transparent', border: 'none', cursor: 'pointer', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 4 }}>
      ...
      <button onClick={() => { try { router.push('/account'); } catch (e) { try { window.location.href = '/account'; } catch (err) {} } }} aria-label="Account" title="Account" type="button" style={{ background: 'transparent', border: 'none', cursor: 'pointer', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 4 }}>
